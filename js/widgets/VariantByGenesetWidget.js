...
var VariantByGenesetWidget = function(selector){
...
var variant_explorer = function(l){
    ...
    if (genes != null){
      ...
      genes.forEach(function(gene){
        var request = GASearchVariantsRequest(gene_census[gene]['start'], gene_census[gene]['end'], gene_census[gene]['referenceName'], ["1"]);
